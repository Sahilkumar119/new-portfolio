    ...
    return (
        <section id="projects" className={classes.section}>
            ...
            <div className={classes.grid}>
                {topProjects.slice(0, 4).map((project, i) => (
                    <div key={i} className={classes.card}>
                        <div className={classes.cardHeader}>
                            <h3 className={classes.cardTitle}>{project.title}</h3>
                            <div className={classes.links}>
                                {project.github && project.github !== "#" && (
                                    <a href={project.github} target="_blank" rel="noopener noreferrer" className={classes.linkIcon}>
                                ...
                                {project.link && project.link !== "#" && (
                                    <a href={project.link} target="_blank" rel="noopener noreferrer" className={classes.linkIcon}>
